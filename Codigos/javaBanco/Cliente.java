...
public void transferirSaldo(Cliente destinatario, double valor){
        if (valor > 0 && valor <= this.saldo){
            this.saldo -= valor;
            destinatario.saldo += valor;
            System.out.println("Transferência da conta " + this.id_cliente +
                               " para a conta " + destinatario.id_cliente +
